...
Puede hacer clic en el botón de alternar *Mostrar el uso actual* para ver el consumo actual y el uso en ráfaga con respecto al período de facturación de la suscripción. No se basan en el rango de fechas de la consulta.
