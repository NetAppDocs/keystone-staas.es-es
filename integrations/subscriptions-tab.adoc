...
+
image:console-subscription.png["ver los detalles de la pestaña de suscripción"]
...
** *Días hasta el vencimiento de la suscripción*: Muestra un icono junto a la fecha de vencimiento para indicar cuánto tiempo queda para que venza la suscripción y si se renovará automáticamente. Este estado es de solo lectura y refleja las condiciones de tu contrato. Para consultar los detalles del contrato, consulta link:../integrations/subscription-timeline.html["Ver la cronología de sus suscripciones a Keystone"].
+
Cuando la renovación automática está desactivada, el color del icono indica la proximidad de la fecha de caducidad:

+
*** *Verde*: Quedan más de 120 días para que caduque.
*** *Naranja*: Quedan entre 91 y 120 días para que caduque.
*** *Rojo*: Quedan menos de 90 días para que caduque. Para evitar interrupciones en el servicio, envía una solicitud de renovación al soporte de NetApp Keystone.
*** *Gris*: la suscripción ha caducado.
+
En el caso de las suscripciones con la renovación automática activada, aparece un icono de renovación automática que indica que la suscripción se renovará automáticamente al finalizar el periodo actual.
