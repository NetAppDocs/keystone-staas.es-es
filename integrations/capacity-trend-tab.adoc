...
summary: Pestaña de tendencia de consumo en el panel de suscripción de Keystone 
---
= Pestaña Tendencia de consumo
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
La pestaña *Tendencia de consumo* muestra los datos históricos de tus suscripciones de Keystone durante un período específico.
...
image:aiq-ks-subtime-6.png["Pestaña Tendencia de capacidad con detalles"]
