...
---
= Ver volúmenes de ONTAP y detalles de almacenamiento de objetos para suscripciones de Keystone
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Puedes usar *Ocultar/Mostrar columnas* para añadir o quitar columnas que se muestran en la tabla. Por defecto, la tabla muestra tus preferencias de columnas guardadas previamente. Las columnas añadidas recientemente, como las columnas *Departamento* o *Huella total*, están ocultas por defecto y debes seleccionarlas manualmente para que aparezcan en la tabla. Puedes seleccionar o deseleccionar cualquier columna, y tus preferencias se guardarán para usarlas después. Al descargar el informe CSV, todas las columnas disponibles se incluyen en la exportación sin importar tus preferencias de visualización.
