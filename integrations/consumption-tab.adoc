...
Puedes ver el uso de capacidad proyectado para los próximos 120 días a partir de la fecha actual usando el interruptor *Forecast* disponible en la vista *Consumo histórico* de la pestaña *Tendencia de consumo* en la Console. El interruptor está activado por defecto.

Por defecto, el gráfico muestra los últimos 30 días de consumo histórico y una proyección de 120 días a partir de la fecha actual en el mismo gráfico. Se trazan hasta 30 puntos de datos en total (20 para datos históricos y 10 para datos de pronóstico), con una línea vertical que separa los dos segmentos.

image:forecast-1.png["captura de pantalla con datos de previsión"]

Si seleccionas un intervalo de fechas que no termina en la fecha actual, la previsión se desactiva automáticamente. Para volver a activarla, un cuadro de diálogo de confirmación te informa que los datos de previsión solo están disponibles cuando la línea temporal seleccionada termina en la fecha actual. Al confirmar, la vista se restablece al intervalo predeterminado de los últimos 30 días de datos históricos más los próximos 120 días de previsión.

Si se prevé que el consumo superará la capacidad de ráfagas, aparecerá un indicador de alerta en el gráfico, recomendando una actualización de la capacidad.
...
En la Consola, además del uso de ráfagas facturado, también puedes ver el uso de ráfagas no facturado (devengado pero aún no facturado) y el uso de ráfagas provisional (devengado en el periodo de facturación actual y aún no facturado).
...
También puedes descargar los datos en formato Excel, incluido el estado de las ráfagas (facturadas, no facturadas o provisionales) y el periodo de facturación.
