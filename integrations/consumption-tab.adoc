...
+
El gráfico de líneas muestra datos históricos de consumo y permite a los usuarios analizar tendencias en un intervalo de fechas seleccionado. El gráfico muestra métricas como capacidad utilizada (capacidad total de almacenamiento, incluyendo tanto datos como datos de captura de pantalla), datos (capacidad de almacenamiento utilizada por datos de usuario) y captura de pantalla (capacidad de almacenamiento utilizada por datos de captura de pantalla), junto con capacidad comprometida y de ráfaga. Según el intervalo de fechas de tu consulta, los gráficos de uso muestran hasta 30 puntos de recopilación de datos. Puedes pasar el cursor del ratón por encima del gráfico para ver el desglose de uso en cada punto de recopilación de datos.
