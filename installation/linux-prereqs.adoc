...
Se requieren las siguientes configuraciones para el servidor Linux:
...
Las siguientes configuraciones son necesarias para la máquina virtual de servidor (SVM) Keystone Collector:
