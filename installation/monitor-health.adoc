...
---
= Supervisión del estado de Keystone Collector
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Una vez descargado el archivo, puedes adjuntarlo al ticket de soporte de Keystone ServiceNow. Para obtener información sobre cómo recaudar fondos, consulte link:../concepts/support-services.html["Generando solicitudes de servicio"].
