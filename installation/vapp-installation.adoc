...
. En el _Paso 4: Revisar detalles_, verifique la exactitud y autenticidad del archivo OVA.
+
...
NOTE: Para las versiones 7.x y anteriores de vCenter, debe actualizar vCenter y ESXi a la versión 8.0 o posterior. Las versiones anteriores ya no reciben soporte.
