...
[role="lead"]
Los requisitos de capacidad para los niveles de servicio de rendimiento de Keystone STaaS difieren según el archivo, bloque, objeto o almacenamiento en la nube compatible con la suscripción de Keystone STaaS.
