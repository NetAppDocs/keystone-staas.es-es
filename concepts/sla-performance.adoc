...
| <=1ms | <=1ms | <=4ms | >=4ms 
|===
Para saber más sobre los requisitos de latencia de los niveles de servicio de rendimiento, consulta link:../concepts/service-levels.html["Niveles de servicio de rendimiento en Keystone"].
...
Según el cálculo, los créditos de servicio serán $12.
...
* Los créditos de servicio podrían aplicarse a una factura futura. Los créditos de servicio no se aplican a las suscripciones Keystone caducadas. Para saber más, consulta link:../concepts/support-services.html["Soporte de NetApp Keystone"].
