...
Puedes ponerte en contacto con el equipo de soporte de Keystone para suscribirte a Keystone versión 3 (v3). Para más detalles, consulta link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["Servicios de asistencia para Keystone"].
