...
Puede ponerse en contacto con el equipo de soporte de Keystone para suscribirse a Keystone versión 3 (v3). Para obtener más detalles, consulte link:https://docs.netapp.com/us-en/keystone-staas/concepts/support-services.html["Obtén ayuda con Keystone"].
