...
---
= Requisitos de instalación de Keystone Collector en modo privado
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Sólo los paquetes de terceros enumerados anteriormente son compatibles con Keystone Collector. Instalar software adicional no es compatible y puede afectar el rendimiento del recopilador, la recopilación de datos y la precisión de la facturación.
...
* Cada mes, exporta un archivo desde Keystone Collector y envíalo por correo electrónico al equipo de soporte de NetApp. Para obtener más información sobre cómo ponerte en contacto con el equipo de soporte, consulta link:../concepts/support-services.html["Servicios de asistencia para Keystone"].
